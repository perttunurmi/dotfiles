        ...
        widget_template = {
            {
                ...
                left = 10,  -- Lisää padding vasemmalle
                right = 10, -- Lisää padding oikealle
...
globalkeys = gears.table.join(
    awful.key({}, "XF86AudioLowerVolume", function()
        awful.util.spawn("/usr/bin/wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-", false)
    end),
    awful.key({}, "XF86AudioRaiseVolume", function()
        awful.util.spawn("/usr/bin/wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+", false)
    end),
    awful.key({}, "XF86AudioMute", function()
        awful.util.spawn("/usr/bin/wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle", false)
    end),
    -- Media Keys
    ...
    awful.key({ modkey, "Shift" }, "m", awesome.quit, { description = "quit awesome", group = "awesome" }),
